...
* **Thu nhập ($\mu_{Income}$):** Nhóm `Response=1` đạt **\$60,076.7**, vượt trội **$+19.5\%$** so với nhóm `Response=0` (\$50,244.3).

* **Sức mua ($\mu_{Total\_Spent}$):** Nhóm `Response=1` đạt **\$985.7**, bứt phá tăng trưởng **$+82.5\%$** so với nhóm từ chối (\$540.2).

* **Độ trung thành ($\mu_{Customer\_Tenure}$):** Thời gian gắn bó đạt **448.1 ngày**, dài hơn nhóm từ chối **$+33.0\%$** (337.0 ngày).
